...
class NNetImage(object):
    ...
    def train_more(self, epochs, learning_rate=None, noise_sigmas=None, verbose=True, loss_update_callback=None, param_update_callback=None, freeze_dividers=False):
        """
